...
# # syntax is the what we write code
# # in javascript, we could write a variable like this
# # var name = "John"
...
print(phrase2[0])#prints the first letters
print(phrase2[1])
print(phrase2[5])#prints the 6th letter of the string
print(phrase2[13])#prints the index of
#string slicing if I wanted to get
#entire word
print(phrase2[13:18])#prints the first
print(phrase2[19:23])
print(phrase2[0:7])
print(phrase2[-1])
